...
В файле requirements.txt содержатся все необходимые зависимости.Следующим шагом запустим виртуальное окружение и установим все версии из файла requirements.txt.
```bash
